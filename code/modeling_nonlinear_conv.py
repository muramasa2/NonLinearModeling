...
model_save_path = f'./weight/model_conv_{structure}_dist_type{type}_weight{in_len}_{out_len}_{step}_reg{reg}_{mode}.h5'
epochs = 100
...
plt.legend()
plt.show()
plt.savefig(f'model_conv_{structure}_dist_type{type}_weight{in_len}_{out_len}_{step}_reg{reg}_{mode}.jpg')
